<template>
    <v-card :to="`/services/${service.id}`" outlined class="rounded-xl">
        <v-img :src="service.img" class="rounded-xl ma-1 align-end"
            gradient="180deg, rgba(0,0,0,0) 40%, rgba(0,0,0,1) 100%">
